...
public class BootProj10MiniProjectProfilesYmlApplication {
	...
	public static void main(String[] args) {
		...
		SpringApplication application = new SpringApplication(BootProj10MiniProjectProfilesYmlApplication.class);
