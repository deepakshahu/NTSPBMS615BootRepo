...
public class MongoDBRunnerTest implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		//=====================save() method======================
		/*try {
			//Tourist tourist = new Tourist(null, "Deepak", "UP", 25.5f, "N4017151", 9869677106L, true);  //With 7 fields

			Tourist tourist = new Tourist();
			tourist.setTouristName("Harsh");
			tourist.setNativePlace("Gujrat");   //With 3 fields

			Tourist tourist = new Tourist(null, "Deepak", "UP", 25.5f, "N4017151", 9869677106L, true, 20, LocalDateTime.of(2022, 10, 25, 11, 34, 58));
