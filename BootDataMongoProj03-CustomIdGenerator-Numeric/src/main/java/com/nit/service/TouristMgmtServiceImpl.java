...
public class TouristMgmtServiceImpl implements ITouristMgmtService {
	...
	public String registerTourist(Tourist tourist) {
		return "Document is saved with the id value :: "+touristRepo.insert(tourist).getTouristId();
	}
	...
	public String modifyTouristById(Integer id, long contactNo) {
		...
		if(opt.isPresent()) {
			...
			return touristRepo.save(tourist).getTouristId()+" is updated with new contactNo";
		}
		else
